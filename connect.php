...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkUserQuery = "SELECT * FROM reg_tbl WHERE email_address = :email";
    ...
    try {
        ...
        if ($stmt1->rowCount() > 0) {
            ...
            if (strlen($password) < 8 || !preg_match('@[A-Z]@', $password) || !preg_match('@[a-z]@', $password) || !preg_match('@[0-9]@', $password) || !preg_match('/[!@#$%^&*(),.?":{}|<>]/', $password)) {
                ...
                $insertQuery = "INSERT INTO reg_tbl (username, first_name, middle_name, last_name, gender, birthdate, age, email_address, password) VALUES (:username, :firstName, :middleName, :lastName, :gender, :birthdate, :age, :email, :password)";
